  ...
  const categories = [
    {
      ...
      link: "https://docs.google.com/forms/d/e/1FAIpQLSdPZLNVp43SoG5u3CT7rIi18YtMoG_7PpLZqucluzVgHd0cFQ/viewform?usp=sharing"
    },
  ];
  const coordinators = [
    { name: "Mani Deepankar", role: "E-sports convenor", phone: "6303970151" },
    { name: "T. Akshitha Reddy", role: "Event Coordinator", phone: "7386593444" },
  ];
  return (
    <div className="relative min-h-screen flex flex-col items-center text-white overflow-hidden">
      ...
      {isLoading ? (
        ...
        <>
          <Image
            src="/images/bgimg/bgfreefire.jpg" // Replace with your actual logo path
            alt="background bgmi"
            width={850}
            height={50}
          ...
          <div className="relative z-10 p-4 sm:p-10">
            ...
            <div className="flex justify-center mt-6">
              <Image
                src="/images/esports/freefire.png"
                alt="bgmi"
                width={150}
                height={150}
