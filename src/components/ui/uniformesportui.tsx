...
const Uniformesportui: React.FC<UniformGridProps> = ({ events }) => {
  return (
    <section className="pt-10 text-white min-h-screen">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-8 px-4 max-w-7xl mx-auto">
...
export default Uniformesportui;
