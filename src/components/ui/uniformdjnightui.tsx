...
const Uniformdjnightui: React.FC<UniformGridProps> = ({ events }) => {
  return (
    <section className="pt-10 text-white min-h-screen">
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 gap-8 px-4 max-w-2xl mx-auto">
...
export default Uniformdjnightui;
